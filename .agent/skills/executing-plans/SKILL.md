...
description: Executes written implementation plans in batches with sequential review checkpoints. Use when you have a written implementation plan to execute in a separate session.
---
