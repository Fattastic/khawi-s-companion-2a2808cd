-- 006_junior_safety_merged.sql
-- Khawi Junior: kids + runs + time-limited appointed driver grants + audit + SOS + live tracking
-- Run after core tables (001-003). This is the "safe" Junior module.
